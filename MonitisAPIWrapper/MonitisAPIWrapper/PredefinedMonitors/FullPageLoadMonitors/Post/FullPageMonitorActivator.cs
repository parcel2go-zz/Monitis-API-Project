...
{
    public class FullPageMonitorActivator
    {
        ...
        public FullPageMonitorActivator(IRequestSender<SimpleResponse> requestSender, ILog log )
        {
        ...
        public void Activate()
        {
            ...
            {
                Log.Error("Could not suspend monitors", exception);
                Success = false;
            }
        }
