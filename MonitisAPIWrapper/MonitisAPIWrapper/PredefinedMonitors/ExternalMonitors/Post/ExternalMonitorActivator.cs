...
{
    public class ExternalMonitorActivator
    {
        ...
        public ExternalMonitorActivator(IRequestSender<SimpleResponse> requestSender, ILog log )
        {
        ...
        public void Activate()
        {
            ...
            {
                Log.Error("Could not activate monitor", exception);
                Success = false;
            }
        }
