...
namespace MonitisAPIWrapper.PredefinedMonitors.ExternalMonitors.Get
{
    ...
    {
        public IRequestSender<TagsResponse> RequestSender { get; set; } // send and receive
        public ILog Log { get; set; } // log errors

        public bool Success { get; private set; }
        public TagsResponse Result { get; private set; }

        public TagsGetter(IRequestSender<TagsResponse> requestSender, ILog log )
        {
        ...
        public void Get()
        {
            ...
            {
                Success = false;
                Log.Error("Couldn't get tags list", exception);
            }
        }
