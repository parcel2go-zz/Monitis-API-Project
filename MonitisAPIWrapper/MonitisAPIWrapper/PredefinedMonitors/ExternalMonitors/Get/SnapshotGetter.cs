...
{
    public class SnapshotGetter
    {
        public IRequestSender<List<SnapshotResponse>> RequestSender { get; set; } // send and receive
        public ILog Log { get; set; } // logs errors 
        ...
        public List<SnapshotResponse> Result { get; set; }

        public SnapshotGetter(IRequestSender<List<SnapshotResponse>> requestSender, ILog log )
        {
        ...
        public void Get()
        {
            ...
            {
                Log.Error("Could not get snapshot", exception);
                Success = false;
            }
        }
