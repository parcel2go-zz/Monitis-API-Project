...
{
    public class StepCaptureGetter
    {
        public IRequestSender<StepCaptureResponse> RequestSender { get; set; } // send and receive
        ...
        public StepCaptureResponse Result { get; private set; }

        public StepCaptureGetter(IRequestSender<StepCaptureResponse> requestSender, ILog log)
        {
        ...
        public void Get()
        {
            ...
            {
                Log.Error("Couldn't capture transaction step", exception);
                Success = false;
            }
        }
