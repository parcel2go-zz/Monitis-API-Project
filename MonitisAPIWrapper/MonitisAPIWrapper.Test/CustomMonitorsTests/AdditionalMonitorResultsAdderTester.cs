...
{
    [TestFixture]
    public class AdditionalMonitorResultsAdderTester : CustomMonitorDependentTest
    {
        [Test]
        public void CanAddMonitorResults()
        {
            var resultsAdder = Container.Resolve<AdditonalCustomMonitorResultsAdder>();

            resultsAdder.MonitorId = MonitorId;
            resultsAdder.CheckTime = DateTime.Now;
