...
{
    [TestFixture]
    public class MonitorResultsGetterTester : InjectedTest
      //  ExternalMonitorDependentTest
    {
        [Test]
        public void CanGetMonitorResultsUsingChecksum()
        {
            var getter = Container.Resolve<ExternalMonitorResultsGetter>();
