...
namespace MonitisAPIWrapper.Test.PredefinedMonitorsTests.FullPageLoadMonitorsTests
{
    [TestFixture]
    public class MonitorSuspenderTester : InjectedTest
    {
        [Test]
        public void CanSuspendMonitor()
        {
            var suspender = Container.Resolve<FullPageMonitorSuspender>();
